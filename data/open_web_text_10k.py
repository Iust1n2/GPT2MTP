...
if __name__ == '__main__':
    # Directory setup
    save_dir = os.path.dirname(os.path.abspath(__file__).replace('data', 'data/open_web_text_10k'))
    ...
    for split, dset in tokenized.items():
        ...
        total_batches = min(1024, max(1, len(dset) // 10))  # Ensure valid shard count
